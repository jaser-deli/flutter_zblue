package com.jaser.flutter_zblue;
 ...
 * FlutterZbluePlugin
 */
public class FlutterZbluePlugin implements FlutterPlugin, MethodCallHandler {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        final MethodChannel channel = new MethodChannel(flutterPluginBinding.getFlutterEngine().getDartExecutor(), "flutter_zblue");
        channel.setMethodCallHandler(new FlutterZbluePlugin());
    }
    ...
    public static void registerWith(Registrar registrar) {
        final MethodChannel channel = new MethodChannel(registrar.messenger(), "flutter_zblue");
        channel.setMethodCallHandler(new FlutterZbluePlugin());
    }
